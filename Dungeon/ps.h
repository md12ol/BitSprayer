...
#ifndef BITSPRAYER_PS_H
#define BITSPRAYER_PS_H
...
class psDoc {
 ...
 public:
  ...
  void
  sayATvert(int x, int y, const char *s);//put text at a position, write vert.
  void
  LeftLabel(int y, const char *s);  //make a label at the left, at y position
  void LeftLabel(const char *s);        //make a label at the left, centered
  void
  RightLabel(int y, const char *s); //make a label at the right, at y position
  ...
  //histogrammer
  void
  histPS(double *data, int z, double min, double max, double width, int tall);
  ...
  //make a polygon with center h,k radius r, n points, the phase
  void polygon(int n, float h, float k, float r, float th);
  //make a filld polygon with center h,k radisu r, n points, th phase
  void fillpoly(int n, float h, float k, float r, float th);
  //Make a filled polygon with a black border
  void
  nodepoly(int n, float h, float k, float r, float th, int rr, int gg, int bb);
